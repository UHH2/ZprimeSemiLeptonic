...
for channel in channels:
    ...
    for key, var in _VARIABLES.items():
        ...
        signals_Plotter = [
            ...
            Process(var.get("name") + "_HscalarToTTTo1L1Nu2J_m500_w125p0_res", "H res 500 GeV #times 1000", root.kBlue, 1000),
        ...
        leg_offset_x = 0.0
        leg_offset_y = 0.23
        legend = root.TLegend(nice.coord.graph_to_pad_x(0.4+leg_offset_x), nice.coord.graph_to_pad_y(0.45+leg_offset_y), nice.coord.graph_to_pad_x(0.95+leg_offset_x), nice.coord.graph_to_pad_y(0.73+leg_offset_y))
