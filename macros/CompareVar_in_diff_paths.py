...
for key_var in varlist:
    for key_sample in samplelist:
        ...
        for key_path in paths:
            ...
            hists[key_sample+key_var+key_path]  = TH1D('h_'+key_var+'_'+key_sample+key_path,'h_'+key_var+'_'+key_sample+key_path,100,0,1000)
        ...
        histsDraw[key_sample+key_var+'JER_hybrid'].Add(histsDraw[key_sample+key_var+'JER_scaling'],-1)
        histsDraw[key_sample+key_var+'JER_hybrid'].Divide(histsDraw[key_sample+key_var+'JER_scaling'])
        histsDraw[key_sample+key_var+'JER_hybrid'].Draw()
