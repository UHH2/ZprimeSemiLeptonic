...
cd /nfs/dust/cms/user/karavdia/ttbar_semilep_13TeV/RunII_80X_v2/ttbarLJAnalysis/Selas2015_36fb_271036_284044_JSON_Mtt_shrink_Leppt60_Jetpt180_NottagSFs/elec
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_rsgluon.py &> limits_log_cutBased_rsgluon
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_rsgluon.py &> limits_log_BDT_0_5_rsgluon
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_rsgluon.py &> limits_log_BDT_0_75_rsgluon
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_rsgluon.py &> limits_log_BDT_0_95_rsgluon
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_rsgluon.py &> limits_log_MET_0_rsgluon
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_rsgluon.py &> limits_log_MET_50_rsgluon