...
#path_data=/nfs/dust/cms/group/zprime-uhh/Analysis_UL18_veto/electron/workdir_Analysis_UL18_electron/uhh2.AnalysisModuleRunner.
path_data=/nfs/dust/cms/group/zprime-uhh/Analysis_UL18_veto/muon/workdir_Zprime_Analysis_UL18_muon/uhh2.AnalysisModuleRunner.

#mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_ele_veto/
#cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_ele_veto/
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_muon_veto/
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_muon_veto/
