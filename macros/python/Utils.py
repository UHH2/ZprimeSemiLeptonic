...
sys.path.append(os.environ["CMSSW_BASE"]+"/src/UHH2/ZprimeSemiLeptonic/macros/")
from ModuleRunnerBase import *

from tdrstyle_all import *

import ROOT
ROOT.gInterpreter.ProcessLine('#include "'+os.environ["CMSSW_BASE"]+'/src/UHH2/ZprimeSemiLeptonic/include/constants.hpp"')
