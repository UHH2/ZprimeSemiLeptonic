...
path_data=/nfs/dust/cms/user/deleokse/analysis/ZPrime_2018/Output_2018_AtoB/workdir_Zprime_PreSelec_2018_AtoB/uhh2.AnalysisModuleRunner. 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_AtoB
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_AtoB
...
# # #DATA
for sample_name in DATA_EGamma_Run2018A DATA_EGamma_Run2018B DATA_SingleMuon_Run2018A DATA_SingleMuon_Run2018B
