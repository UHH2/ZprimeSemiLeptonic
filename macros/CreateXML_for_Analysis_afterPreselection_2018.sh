...
path_data=/nfs/dust/cms/user/deleokse/RunII_102X_v2/ZPrime_2018/Preselection_2810_test/workdir_Zprime_PreSelec_2018/uhh2.AnalysisModuleRunner. 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_2810_test
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_2810_test
...
for sample_name in ZprimeToTT_M1000_W100_2018
