...
path_data=/nfs/dust/cms/group/zprime-uhh/Analysis_UL18/dilepton/workdir_Analysis_UL18_muon_dilepton/uhh2.AnalysisModuleRunner.
...
do
    echo $sample_name
    $pathGL_code/scripts/create-dataset-xmlfile ${path_data}"MC."${sample_name}"*.root" $sample_name.xml
    python $pathGL_code/scripts/crab/readaMCatNloEntries.py 10 $sample_name.xml True
done

# DATA
for sample_name in SingleMuon_RunA_UL18 SingleMuon_RunB_UL18 SingleMuon_RunC_UL18 SingleMuon_RunD_UL18
do
    echo $sample_name
