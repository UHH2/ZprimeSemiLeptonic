...
path_data=/nfs/dust/cms/user/deleokse/analysis/ZprimeSemileptonic/Preselection_QCD_HT/Output_2017/workdir_Zprime_PreSelec_2017/uhh2.AnalysisModuleRunner. 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_20191016
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_20191016
