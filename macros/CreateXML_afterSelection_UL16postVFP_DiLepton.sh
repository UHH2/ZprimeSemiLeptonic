...
# DATA
for sample_name in DATA_SingleMuon_RunF_UL16postVFP DATA_SingleMuon_RunG_UL16postVFP DATA_SingleMuon_RunH_UL16postVFP
do
    echo $sample_name
