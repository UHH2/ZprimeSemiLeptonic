...
void ExtractCustomBTagSF(){
  ...
  // vector<TString> sample_names = {"Diboson", "ZprimeDMToTTbarResoIncl_MZp1000_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp1500_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp2000_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp2500_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp3000_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp3500_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp4000_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp4500_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp5000_Mchi10_V1", "ZprimeDMToTTbarResoIncl_MZp2500_Mchi1000_A1", "ZprimeDMToTTbarResoIncl_MZp2500_Mchi1000_V1", "ZprimeDMToTTbarResoIncl_MZp2500_Mchi10_A1"};
  ...
  for(unsigned int k=0; k<year.size(); k++){
    for(unsigned int j=0; j<channel.size(); j++){
      ...
      for(unsigned int i=0; i<sample_names.size(); i++){
        ...
        // to delete old histograms
        // f = new TFile("files_BTagSF/customBtagSF_" + channel.at(j) + "_" + year.at(k) + ".root", "UPDATE");
        // gDirectory->Delete("N_Jets_vs_HT_" + sample_names.at(i) + ";1");
        h_ratio->Write();
        delete f;
