...
input_dir="/nfs/dust/cms/group/zprime-uhh/Analysis_${year}/JER_down/${channel}/workdir_Analysis_${year}_${channel}_JER_down/"
output_dir="/nfs/dust/cms/group/zprime-uhh/Analysis_${year}/JER_down/${channel}/"
