...
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.others2.root ${output_dir}uhh2.AnalysisModuleRunner.MC.others.root ${output_dir}uhh2.AnalysisModuleRunner.MC.WJets.root
