...
input_dir="/nfs/dust/cms/group/zprime-uhh/AnalysisDNN_${year}/${channel}/workdir_AnalysisDNN_${year}_${channel}/"
...
#   else
#     hadd -T ${output_dir}uhh2.AnalysisModuleRunner.DATA.DATA.root ${input_dir}uhh2.AnalysisModuleRunner.DATA.SingleElectron_Run*.root ${input_dir}uhh2.AnalysisModuleRunner.DATA.SinglePhoton_Run*.root
#   fi
# elif [ ${channel} = "muon" ]; then
#   hadd -T ${output_dir}uhh2.AnalysisModuleRunner.DATA.DATA.root ${input_dir}uhh2.AnalysisModuleRunner.DATA.SingleMuon_Run*.root
# else
...
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.ST_s-channel.root ${input_dir}uhh2.AnalysisModuleRunner.MC.ST_s-channel_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.ST_t-channel.root ${input_dir}uhh2.AnalysisModuleRunner.MC.ST_t-channel_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.ST_tW.root ${input_dir}uhh2.AnalysisModuleRunner.MC.ST_tW_*.root
...
# hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.others2.root ${output_dir}uhh2.AnalysisModuleRunner.MC.WJets.root ${output_dir}uhh2.AnalysisModuleRunner.MC.others.root
