...
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m365_w91p25_int.root ${input_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m365_w91p25_int_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m400_w100p0_int.root ${input_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m400_w100p0_int_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m500_w125p0_int.root ${input_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m500_w125p0_int_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m600_w150p0_int.root ${input_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m600_w150p0_int_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m800_w200p0_int.root ${input_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m800_w200p0_int_*.root
hadd -T ${output_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m1000_w250p0_int.root ${input_dir}uhh2.AnalysisModuleRunner.MC.HpseudoToTTTo1L1Nu2J_m1000_w250p0_int_*.root
