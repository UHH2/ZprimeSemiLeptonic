...
void getRMS(){
  ...
  TString filename_base = "/nfs/dust/cms/user/deleokse/RunII_106_v2/";
  TString filename = "";

  //vector<TString> year = {"UL16preVFP", "UL16postVFP", "UL17", "UL18"};
  vector<TString> year = {"UL16preVFP"};
