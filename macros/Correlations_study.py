...
# python /afs/desy.de/user/k/karavdia/xxl/af-cms/CMSSW_8_0_24_patch1/src/UHH2/ZprimeSemiLeptonic/macros/Correlations_study.py
from ROOT import *
import sys
import numpy
...
varlist = {'ele_pt':'lep_pt','met_pt':'met_pt','jet1_pt':'ljet_pt','jet2_pt':'fjet2_pt','2DminDR_lep_jet':'lep1__minDR_jet','weight':'weight'} #'MYminDR_lep_jet':'dR_lep_cljet'
varnamelist = {'ele_pt':'electron pt, GeV','met_pt':'MET, GeV','jet1_pt':'jet1 pt, GeV','jet2_pt':'jet2 pt,GeV','2DminDR_lep_jet':'2D #deltaR(lep,jet)','weight':'weight'}
Xvarlist = {'lep_pt':'electron pt, GeV','Mttbar':'M_{ttbar}, GeV','raw_met_pt':'raw MET, GeV'}
varlist_upperY = {'ele_pt':3000,'met_pt':2000,'jet1_pt':3000,'jet2_pt':3000,'2DminDR_lep_jet':5.0,'weight':10.}
Xvarlist_upperX = {'lep_pt':3000,'Mttbar':10000,'raw_met_pt':3000}
...
for key_sample in samplelist:
    ...
    for key_Xvar in Xvarlist: 
        for key_var in varlist:
            canvas[key_var+key_sample] = TCanvas('Correlation__'+key_Xvar+'_'+key_var,'Correlation_'+key_var,800,600)
...
#            print "", Xvarlist_upperX[key_Xvar]
            ...
            if key_var == 'weight':
                low_y = -10
            hists[key_var+key_sample]  = TH2D('h_'+key_Xvar+'__'+key_var,'h_'+key_Xvar+'__'+key_var,50,0,Xvarlist_upperX[key_Xvar],50,low_y,varlist_upperY[key_var])
