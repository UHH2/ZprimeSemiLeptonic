...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_Vars_BTagM_JER_up
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_Vars_BTagM_JER_up
