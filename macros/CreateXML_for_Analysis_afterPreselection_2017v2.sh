...
path_data=/nfs/dust/cms/group/zprime-uhh/HOTVR/Presel_2017/workdir_Zprime_PreSelec_2017/uhh2.AnalysisModuleRunner.
...
for sample_name in TTToHadronic_2017v2
do
    echo $sample_name
