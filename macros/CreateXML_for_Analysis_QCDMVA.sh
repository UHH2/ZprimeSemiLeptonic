...
#path=/nfs/dust/cms/user/karavdia/ttbar_semilep_13TeV/RunII_80X_v2/ttbarLJSkimming/Selas2015_27fb_QCD/workdir_Skimming/uhh2.AnalysisModuleRunner.
#path=/nfs/dust/cms/user/karavdia/ttbar_semilep_13TeV/RunII_80X_v2/ttbarLJSkimming/Selas2015_36fb_QCD/workdir_Skimming/uhh2.AnalysisModuleRunner.
path=/nfs/dust/cms/user/karavdia/ttbar_semilep_13TeV/RunII_80X_v2/ttbarLJSkimming/Selas2015_36fb_QCD_cutElecID/workdir_Skimming/uhh2.AnalysisModuleRunner.
mkdir -p /afs/desy.de/user/k/karavdia/CMSSW_8_0_19_patch2/UHH2/ZprimeSemiLeptonic/Skimming_datasets_36fb_QCD_cutElecID
cd /afs/desy.de/user/k/karavdia/CMSSW_8_0_19_patch2/UHH2/ZprimeSemiLeptonic/Skimming_datasets_36fb_QCD_cutElecID
...
echo "MC.TTbar"
~/CMSSW_8_0_19_patch2//UHH2/scripts/create-dataset-xmlfile $path"MC.TTbar_*" MC_TTbar.xml
