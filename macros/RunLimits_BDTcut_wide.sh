...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_wide.py &> limits_log_cutBased_wide
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_wide.py &> limits_log_BDT_0_5_wide
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_wide.py &> limits_log_BDT_0_75_wide
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_wide.py &> limits_log_BDT_0_95_wide
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_wide.py &> limits_log_MET_0_wide
...
~/theta/utils2/theta-auto.py ~/RunLimits_Zprime/Limits/bayesianlimits_wide.py &> limits_log_MET_50_wide