{
  TString input_directory = "/nfs/dust/cms/user/deleokse/RunII_106_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/macros/src/Scale_hists/UL18/muon/";
  ...
  for(int i=0; i<v_samples.size(); i++){
    ...
    h_mcscale_up->GetXaxis()->SetRangeUser(100,6000);
    // y axis
