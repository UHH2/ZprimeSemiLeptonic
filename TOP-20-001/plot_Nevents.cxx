{
  TString input_dir = "/nfs/dust/cms/user/jabuschh/uhh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/TOP-20-001/output_Nevents/";
  TString save_dir = "/nfs/dust/cms/user/jabuschh/uhh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/TOP-20-001/plots_Nevents/";
  ...
  for(int i=0; i<v_hists.size(); i++){
    ...
    // y axis
    h_data_plot_errTotal->GetYaxis()->SetTitle("Events");
    h_data_plot_errTotal->GetYaxis()->SetTitleOffset(2.1);
    ...
    hist_ratio_errTot->GetYaxis()->SetTitleOffset(0.5);
