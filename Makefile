...
USERLDFLAGS := -lSUHH2core -lSUHH2common -lTMVA -lGenVector -lSUHH2HOTVR -lSUHH2JetMETObjects -L${LHAPDFLIB} -L${LWTNNLIB} -lLHAPDF -llwtnn -L/cvmfs/cms.cern.ch/${SCRAM_ARCH}/cms/cmssw/${CMSSW_VERSION}/lib/${SCRAM_ARCH} -lPhysicsToolsTensorFlow -L${TFLOWLIB} -ltensorflow_framework -L${PBUFLIB} 
