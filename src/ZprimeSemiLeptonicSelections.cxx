...
DijetSelection::DijetSelection(float dphi_min_, float third_frac_max_):
  dphi_min(dphi_min_), third_frac_max(third_frac_max_) {}
...
HTlepCut::HTlepCut(Context & ctx, float min_htlep, float max_htlep):
  h_htlep_(ctx.get_handle<double>("HTlep")), min_htlep_(min_htlep), max_htlep_(max_htlep) {}
...
HypothesisDiscriminatorCut::HypothesisDiscriminatorCut(uhh2::Context& ctx, double min_discr, double max_discr, const std::string& discr_name, const std::string& hyps_name):
...
METCut::METCut(double min_met_, double max_met_):
  min_met(min_met_), max_met(max_met_) {}
...
NJetCut::NJetCut(int nmin_, int nmax_, double ptmin_, double etamax_):
...
CMSTopTagOverlapSelection::CMSTopTagOverlapSelection(double delR_Lep_TopTag_, double delR_Jet_TopTag_):
  delR_Lep_TopTag(delR_Lep_TopTag_), delR_Jet_TopTag(delR_Jet_TopTag_), topjetid(CMSTopTag()) {
