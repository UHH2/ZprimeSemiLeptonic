...
ZprimePreSelectionHists::ZprimePreSelectionHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void ZprimePreSelectionHists::fill(const Event & event){
...
ZprimePreSelectionHists::~ZprimePreSelectionHists(){}
