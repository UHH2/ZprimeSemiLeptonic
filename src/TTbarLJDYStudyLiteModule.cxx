...
class TTbarLJDYStudyLiteModule : public ModuleBASE {

 public:
  explicit TTbarLJDYStudyLiteModule(uhh2::Context&);
...
TTbarLJDYStudyLiteModule::TTbarLJDYStudyLiteModule(uhh2::Context& ctx){
  ...
  //   std::string log("TTbarLJDYStudyLiteModule::TTbarLJDYStudyLiteModule -- ");
  //   log += "TTbarLJDYStudyLiteModule::TTbarLJDYStudyLiteModule -- invalid argument for 'channel' key in xml file (must be 'muon' or 'elec'): \""+channel+"\"";
  ...
  //   //triangul_cut = false;
  // }
  // else throw std::runtime_error("TTbarLJDYStudyLiteModule::TTbarLJDYStudyLiteModule -- undefined \"keyword\" argument in .xml configuration file: "+keyword);
  //
...
bool TTbarLJDYStudyLiteModule::process(uhh2::Event& event){
...
UHH2_REGISTER_ANALYSIS_MODULE(TTbarLJDYStudyLiteModule)
