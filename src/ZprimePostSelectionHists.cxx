...
ZprimePostSelectionHists::ZprimePostSelectionHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void ZprimePostSelectionHists::fill(const Event & event){
...
ZprimePostSelectionHists::~ZprimePostSelectionHists(){}
