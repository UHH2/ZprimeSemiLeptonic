...
ZprimeAnalysisModule_applyNN::ZprimeAnalysisModule_applyNN(uhh2::Context& ctx){
  ...
  DeltaEta_selection.reset(new DeltaEtaSelection(ctx)); // Cut on DeltaEta(j1,j2)<3. to reduce QCD spikes
