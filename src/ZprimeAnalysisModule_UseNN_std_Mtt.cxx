...
ZprimeAnalysisModule_UseNN_std_Mtt::ZprimeAnalysisModule_UseNN_std_Mtt(uhh2::Context& ctx){
 ...
 // Remove TwoD cut for DNN 
  ...
  vector<string> histogram_tags = {"TwoDCut","DNN_output0","DNN_output1","DNN_output2","DNN_output3", "DNN_output0_TopTag","DNN_output1_TopTag","DNN_output2_TopTag","DNN_output3_TopTag","DNN_output0_NoTopTag","DNN_output1_NoTopTag","DNN_output2_NoTopTag","DNN_output3_NoTopTag"};
