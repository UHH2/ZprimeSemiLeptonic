...
dir="/nfs/dust/cms/group/zprime-uhh/Analysis_UL16preVFP/muon/workdir_Zprime_Analysis_UL16preVFP_muon/"

# DATA
for i in DATA_SingleMuon_RunB_UL16preVFP_blinded DATA_SingleMuon_RunC_UL16preVFP_blinded DATA_SingleMuon_RunD_UL16preVFP_blinded DATA_SingleMuon_RunE_UL16preVFP_blinded DATA_SingleMuon_RunF_UL16preVFP_blinded
do
  echo "----- ${i} -----"
