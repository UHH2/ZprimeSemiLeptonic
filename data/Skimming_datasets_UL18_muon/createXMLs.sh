...
for i in DATA_SingleMuon_RunB_UL18 DATA_SingleMuon_RunC_UL18 DATA_SingleMuon_RunD_UL18
do
  echo "----- ${i} -----"
  ./../../../scripts/create-dataset-xmlfile "/nfs/dust/cms/user/jabuschh/ZprimeSemiLeptonic/RunII_106X_v2/UL18/muon/ZPrime_DeepAK8/workdir_Zprime_Analysis_UL18_muon/uhh2.AnalysisModuleRunner.DATA.${i}_*.root" ${i}.xml
...
do
  echo "----- ${i} -----"
  ./../../../scripts/create-dataset-xmlfile "/nfs/dust/cms/user/jabuschh/ZprimeSemiLeptonic/RunII_106X_v2/UL18/muon/ZPrime_DeepAK8/workdir_Zprime_Analysis_UL18_muon/uhh2.AnalysisModuleRunner.MC.${i}_*.root" ${i}.xml
  python ../../../scripts/crab/readaMCatNloEntries.py 10 ${i}.xml True
done
