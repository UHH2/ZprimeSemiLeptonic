...
dir="/nfs/dust/cms/group/zprime-uhh/Analysis_UL16postVFP/muon/workdir_Zprime_Analysis_UL16postVFP_muon/"

# DATA
for i in DATA_SingleMuon_RunF_UL16postVFP_blinded DATA_SingleMuon_RunG_UL16postVFP_blinded DATA_SingleMuon_RunH_UL16postVFP_blinded
do
  echo "----- ${i} -----"
